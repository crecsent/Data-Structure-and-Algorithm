...
int main()
{
	...
	MinHeap<int> mh;
	cout << "Before push, mh is empty?" << mh.isEmpty() << endl;
	cout << "Pushing 0,2,...,18 and 1,3,...,19" << endl;
	for (int i = 0; i < 20; i += 2)
		mh.push(i);
	for (int i = 1; i < 20; i += 2)
		mh.push(i);

	cout << "After push, mh is empty?" << mh.isEmpty() << endl;
	cout << "Traverse in level order:"<< endl;
	mh.traverse();
	system("pause");
}